...
const Prescription = () => {
    ...
    const [text] = useTypewriter({
      words: [ "Securely upload your prescription here!", "Your health matters. Upload your prescription now!", "Easy prescription upload—just a click away!"],
      loop: true,
      typeSpeed: 50,
      deleteSpeed: 50,
      delaySpeed: 2000,
    ...
    return (
      ...
      <div className="flex-shrink-0 h-96  rounded-lg  mt-32">
          <Lottie animationData={signup2} className="h-full"/>
      </div>
  </div>
